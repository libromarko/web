...
export default function PrivacyPolicy() {
  return (
    <div style={{ minHeight: "100vh", marginLeft: 50, marginRight: 50 }}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to libromarko.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to libromarko, accessible from{" "}
              <a
                href="https://libromarko.xyz"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://libromarko.xyz
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: info@libromarko.xyz</li>
        </ul>
    </div>
  );
}
